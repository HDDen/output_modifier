...
if (!file_exists($_SERVER['DOCUMENT_ROOT'].'/'.$webp_core_fallback_location.'/output_modifier.php')){
    $outputmod__docrootlength = mb_strlen(rtrim($_SERVER['DOCUMENT_ROOT'], '/\\')) + 1; // docroot + slash
...
$default_params = array(
    'webp' => array(
        ...
        'cwebp' => array(
            'commandline_options' => '-sharp_yuv', // false / string. Can add '-sharp_yuv', for example
    ...
    'lazyload' => array( // array of tags or selectors
        'img' => array( // parameters for others is equal, copy and change tagname
            ...
            // 'inline_preloader_picture' => "data:image/svg+xml;base64,PHN2ZyB4bWxucz0naHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmcnIHZpZXdCb3g9JzAgMCA4NzQgNTg5JyBwcmVzZXJ2ZUFzcGVjdFJhdGlvPSdub25lJz48L3N2Zz4=", // svg is free to resize
            'inline_preloader_picture' => WEBPPROJECT_URL . "/staff/img/dummy.svg", // svg is free to resize
        ...
        'div' => array(
            ...
            // 'inline_preloader_picture' => "data:image/svg+xml;base64,PHN2ZyB4bWxucz0naHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmcnIHZpZXdCb3g9JzAgMCA4NzQgNTg5JyBwcmVzZXJ2ZUFzcGVjdFJhdGlvPSdub25lJz48L3N2Zz4=",
            'inline_preloader_picture' => WEBPPROJECT_URL . "/staff/img/dummy.svg",
            'expand_preload_area' => true, // expand image load area before it displays
            'expand_attr' => 'data-expand', // from where read 'expand_preload_area' parameter
            'expand_range' => '500', // default for expanding
        ),
